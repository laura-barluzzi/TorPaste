...
problem, you can use the below provided  initializeBackend()  that  can
...
def new_paste(pasteid, pastecontent):
    """
...
def update_paste_metadata(pasteid, metadata):
    """
...
def get_paste_contents(pasteid):
    """
...
def get_paste_metadata(pasteid):
    """
...
def get_paste_metadata_value(pasteid, key):
    """
    ...
    if get_paste_metadata(pasteid)[key]:
        return get_paste_metadata(pasteid)[key]
    else:
        return None
